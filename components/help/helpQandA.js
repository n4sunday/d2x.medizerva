...
class helpQandA extends PureComponent {
	componentDidMount = () => {
		this.props.getAPI(), this.props.resetHistory();
	};
	...
	//---------------------------END IMG_IF_ELSE----------------------------------------
	select1 = () => (
		store.dispatch(select(this.props.api.symptom.U1.nextOrder)), store.dispatch(engineHistory(this.props.api, 1))
	);
	select2 = () => (
		store.dispatch(select(this.props.api.symptom.U2.nextOrder)), store.dispatch(engineHistory(this.props.api, 2))
	);
	getNew = () => (this.props.getAPI(), this.props.resetHistory());
			...
			return (
				<div>
					<div>
						...
						<div className="container-fluid" id="user-qa" onClick={this.select1}>
							<div className="row">
						...
						<div className="container-fluid" id="user-qa" onClick={this.select2}>
							<div className="row">
								<div id="answer" className="col-xs-9 col-sm-10 col-md-9 col-lg-10">
